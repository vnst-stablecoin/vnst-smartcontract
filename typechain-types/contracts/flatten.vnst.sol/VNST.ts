...
export interface VNSTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MODERATOR_ROLE"
...
export interface VNST extends BaseContract {
  connect(runner?: ContractRunner | null): VNST;
  waitForDeployment(): Promise<this>;

  interface: VNSTInterface;
