...
export interface VNSTProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MODERATOR_ROLE"
...
export interface VNSTProxy extends BaseContract {
  connect(runner?: ContractRunner | null): VNSTProxy;
  waitForDeployment(): Promise<this>;

  interface: VNSTProxyInterface;
