...
export interface VNSTProtocolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MODERATOR_ROLE"
...
export interface VNSTProtocol extends BaseContract {
  connect(runner?: ContractRunner | null): VNSTProtocol;
  waitForDeployment(): Promise<this>;

  interface: VNSTProtocolInterface;
